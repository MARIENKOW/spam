        ...
        <Box display="flex" flexDirection="column" gap={2}>
            <Box display="flex" flexWrap="wrap" gap={1}>
                ...
                <Chip
                    ...
                    label={t("pages.admin.tgAccounts.broadcast.history.sentList", { count: sent })}
                    color="success"
                ...
                <Chip
                    ...
                    label={t("pages.admin.tgAccounts.broadcast.history.failedList", { count: failed })}
                    color="error"
                ...
                <Chip
                    ...
                    label={t("pages.admin.tgAccounts.broadcast.history.pendingList", { count: pending })}
                    color="info"
